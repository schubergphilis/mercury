...
type LoadbalancePool struct {
	...
	PreInboundRule  []string                  `json:"preinboundrules" toml:"preinboundrules"` // script based rules applied on incomming connections before passed to the proxy service
