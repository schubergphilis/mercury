...
type HealthCheck struct {
	...
	OnlineState      string              `json:"online_state" toml:"online_state"`         // alternative online_state - default: online / optional: offline / maintenance
	OfflineState     string              `json:"offline_state" toml:"offline_state"`       // alternative offline_state - default: offline
	uuidStr          string
}
